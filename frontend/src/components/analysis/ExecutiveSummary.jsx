...
export default function ExecutiveSummary({ viralityScore = 84.5, confidence = 95.4 }) {
  return (
    <div className="surface-card p-6 sm:p-8 border-slate-800 bg-gradient-to-r from-slate-900 via-brand-950 to-slate-900 text-white shadow-xl space-y-6 text-left relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-4 flex flex-col items-center sm:items-start space-y-3 bg-white/10 backdrop-blur-md p-6 rounded-3xl border border-white/15">
          ...
          <div className="text-[11px] text-slate-300 font-medium">
            Model Confidence Index: <strong className="text-white">{confidence}%</strong>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 space-y-3">
          ...
          <p className="text-sm text-slate-100 font-medium leading-relaxed">
            "Your video features a strong opening hook, high platform format compatibility, and clean kinetic text overlays. The biggest performance risk occurs between <strong className="text-yellow-300">seconds 14 and 18</strong>, where visual motion drops slightly."
          </p>
        ...
        <div className="lg:col-span-3 space-y-4 flex flex-col justify-between h-full border-t lg:border-t-0 lg:border-l border-white/15 pt-4 lg:pt-0 lg:pl-6">
          ...
          <button
            ...
            className="w-full py-3 bg-white hover:bg-slate-100 text-slate-900 font-extrabold text-xs rounded-2xl shadow-lg transition-all flex items-center justify-center space-x-2 hover:scale-[1.02]"
          >
